...
const reliabilityImg = "/sb cranes website pics/img5.png";
const IntegrityImg = "/sb cranes website pics/img6.png";
const SafetyImg = "/sb cranes website pics/img7.png";
const excellenceImg = "/sb cranes website pics/img8.png";
...
const StatItem = ({
  ...
  return (
    <div
      ref={ref}
      className="text-center p-6 border border-white/10 bg-white/5 rounded-lg backdrop-blur-sm"
    >
      ...
      <p className="text-gray-300 text-sm md:text-base tracking-wider uppercase font-medium">
        {label}
      </p>
    </div>
  );
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[40vh] min-h-[300px] flex items-center justify-center overflow-hidden bg-dark-slate">
        <div
          className="absolute inset-0 bg-cover bg-center opacity-40 brightness-75 contrast-125 grayscale-[20%]"
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-300 font-medium">
            Building the future with strength, precision, and over 40 years of
            expertise.
          </p>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 py-16 lg:py-24">
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center mb-24">
          ...
          >
            <div className="relative">
              ...
              <h2 className="text-industrial-blue text-xs font-bold uppercase tracking-[0.2em] mb-4">
                Who We Are
              </h2>
              <h3 className="text-3xl md:text-5xl font-bold uppercase font-header text-dark-slate mb-6 leading-tight">
                ...
                <span className="text-industrial-blue">
              ...
              <div className="space-y-6 text-gray-600 text-lg leading-relaxed">
                <p>
                  We are a leading crane rental and heavy lifting solutions
                  provider operating across India, with over 40 years of proven
                  industry experience supporting construction, infrastructure,
                  industrial, and engineering projects.
                </p>
                <p>
                  Our focus is on reliable equipment, experienced operators, and
                  safe execution. We work closely with contractors and project
                  teams to ensure the right crane is deployed on time, with
                  minimal downtime and smooth site coordination.
                </p>
                <p>
                  From short-term requirements to long-duration projects, we
                  deliver practical lifting solutions that meet real site
                  conditions. Known for consistency, maintenance standards, and
                  on-ground support, we aim to be a dependable crane rental
                  partner for projects of all sizes across entire India and the
                  World.
                </p>
              </div>
            </div>
          ...
          >
            <div className="relative rounded-2xl overflow-hidden shadow-2xl group">
              ...
              <img
                ...
                alt="SB Cranes Fleet"
                loading="lazy"
                className="w-full h-auto transform group-hover:scale-105 transition-transform duration-700 brightness-90 contrast-125 saturate-150 grayscale-[10%]"
              />
              {/* Floating Badge */}
              <div className="absolute bottom-6 right-6 bg-white p-6 rounded-lg shadow-xl z-20 max-w-xs border-l-4 border-brand-red hidden md:block">
                <p className="text-industrial-blue font-bold text-lg mb-1">
                  Trusted Partner
                </p>
                <p className="text-gray-500 text-sm">
                  For major EPC & Infrastructure projects across India.
                </p>
              </div>
            </div>
          </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-24">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-2xl font-bold uppercase font-header text-industrial-blue mb-4">
                Our Vision
              </h3>
              <p className="text-gray-600 leading-relaxed">
                To become a globally recognized crane rental and heavy lifting
                company, delivering world-class solutions through safety,
                innovation, reliability, and operational excellence.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-600 leading-relaxed">
                Deliver world-class crane services while promoting workplace
                safety, responsible operations, and contributing to the
                development of communities and national infrastructure.
              </p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="mb-24">
          <div className="text-center mb-16">
            <h2 className="text-industrial-blue text-xs font-bold uppercase tracking-widest mb-3">
              Our Culture
            </h2>
            <h3 className="text-3xl md:text-5xl font-bold uppercase font-header text-dark-slate">
                  ...
                  <div className="relative group rounded-[2rem] overflow-hidden shadow-2xl shadow-industrial-blue/10 border border-gray-100 p-2 bg-white">
                    ...
                    <div className="absolute bottom-4 left-4 right-4 bg-gradient-to-t from-black/90 to-transparent p-6 z-20 rounded-[1.5rem]">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-white font-header font-bold uppercase tracking-wider">
                          {value.title}
                        </span>
                      </div>
                    </div>
        ...
        <div className="bg-dark-slate rounded-3xl p-8 lg:p-16 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row gap-12 items-center">
            <div className="w-full lg:w-1/2">
              <h2 className="text-brand-red text-sm font-bold uppercase tracking-widest mb-4">
                Why SB Cranes?
              </h2>
              <h3 className="text-3xl md:text-4xl font-bold uppercase font-header text-white mb-8">
                Built on Trust,
                <br /> Driven by Performance
              </h3>
              <button
                onClick={onOpenModal}
                className="bg-brand-red text-white px-8 py-4 font-bold uppercase tracking-widest hover:bg-white transition-colors hover:text-brand-red border border-transparent hover:border-brand-red"
              >
                Partner With Us
              </button>
            </div>
